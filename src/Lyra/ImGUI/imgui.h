...
namespace ImGui
{
    ...
    IMGUI_API bool          ColorPicker4(const char* label, float col[4], ImGuiColorEditFlags flags = 0, const float* ref_col = NULL, ImVec2 pos = ImVec2(0, 0), float size = 0, float spacing = 0, bool sv = false, bool hv = false);
